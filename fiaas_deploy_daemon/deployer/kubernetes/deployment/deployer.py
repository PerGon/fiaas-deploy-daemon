...
class DeploymentDeployer(object):
    ...
    def __init__(self, config, datadog, prometheus, deployment_secrets, owner_references):
        ...
        self._enable_application_service_account = config.enable_service_account_per_app
    ...
    def deploy(self, app_spec, selector, labels, besteffort_qos_is_required):
        ...
        init_containers = []
        service_account_name = app_spec.name if self._enable_application_service_account else "default"
